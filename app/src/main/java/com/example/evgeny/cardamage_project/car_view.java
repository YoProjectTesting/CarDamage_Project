 ...
 */
public class car_view extends View {
    ...
    MainActivity main_activ = (MainActivity) getContext();
    ...
    static List<damaged_point> list_of_points;

    public car_view(Context context, int width, int height) {
        super(context);
        this.width = width;
        this.height = height;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        gameSheet2.setColor(Color.GRAY);
        ...
        for (int i = 0; i < list_of_points.size(); i++) {
            ...
            try {
                ...
                Log.i("MyTag",list_of_points.get(i).toString());
            }
...
//        alert.getWindow().getAttributes().windowAnimations = R.style.DialogAnimation;
    ...
    public class alert_listener implements View.OnClickListener {
    ...
    public class alert_long_listener implements View.OnLongClickListener {

        @Override
        public boolean onLongClick(View v) {
            switch (v.getId()) {
                case R.id.injuredColor:
                    Log.i("myTag", "LongClickListener");
                    damageType = "A";
            ...
            main_activ.startActivityForResult(in1, 1);
